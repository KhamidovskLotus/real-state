  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-semibold text-4xl mt-5 transition-all bg-neutral-100 dark:bg-neutral-800 text-center px-12 py-7 rounded-full">Happening cities </h2>
