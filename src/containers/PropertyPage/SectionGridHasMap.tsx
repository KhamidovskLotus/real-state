  ...
  return (
    <div className="">
      <div className="relative flex min-h-screen">
        ...
        {!showFullMapFixed && (
          <div
            className="flex xl:hidden items-center justify-center fixed bottom-19 left-4 transform -translate-x-1/2 px-4 py-1 bg-neutral-900 text-white shadow-2xl rounded-full z-30  space-x-3 text-sm cursor-pointer"
